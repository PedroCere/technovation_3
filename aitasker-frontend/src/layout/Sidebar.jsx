...
import {
  ...
  ChevronDown, Users, HelpCircle, Sun, Moon, ListTodo, BarChart2, Bot, LayoutGrid
} from "lucide-react";
...
const Sidebar = () => {
  ...
  return (
    <aside className={`${collapsed ? "w-16" : "w-72"} transition-all duration-300 h-screen flex flex-col justify-between px-4 py-4 ${isDark ? "bg-[#1c212c] text-white" : "bg-[#fefcfb] text-black"} font-sans`}>
      {/* Top Section */}
      <div>
        <div className={`flex items-center justify-between mb-6 ${collapsed ? "flex-col gap-3" : ""}`}>
          ...
          <div className="flex gap-2">
            ...
            <button onClick={toggleSidebar} className="hover:opacity-70"><MenuIcon /></button>
          </div>
        </div>
...
const BellIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M18 16V11C18 7.68629 16.2614 4.87973 13.5 4.18462V4C13.5 3.17157 12.8284 2.5 12 2.5C11.1716 2.5 10.5 3.17157 10.5 4V4.18462C7.73858 4.87973 6 7.68629 6 11V16L4 18V19H20V18L18 16Z" fill="currentColor" />
  </svg>
);
